...
import {consultaVentasTablero} from "../../../../services/tools-services";
                ...
                <div className="card sales-card border-0">
                    ...
                    <div className="card-body text-center p-2">
                        <h5 className="card-title fw-bolder">
                            <i className="bi bi-cart me-2"></i>Ventas <span>| {fechaConsulta}</span></h5>
                        ...
                        <div className="mt-2">
                            ...
                            <p className="text-muted small mb-1">
                                Por el momento no hay ventas al día consultado.
                            </p>
                        </div>
                        <hr className="my-3" />
                    </div>
    ...
    return (
        <div className="mb-4">
            <div className="card sales-card border-0">
                ...
                <div className="card-body text-center p-2">
                    <h5 className="card-title fw-bolder">Ventas <span>| {fechaConsulta}</span></h5>
                    <p className="text-blue small fw-bold">Total Ventas {dataState.Total}</p>
                    <div className="mt-2">
